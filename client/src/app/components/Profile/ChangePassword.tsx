      ...
      <div className="w-full">
        ...
        >
          ...
          <div className="w-[100%] 800px:w-[60%] mt-2">
            ...
            <input
              className={`w-[95%] h-[48px] border border-[#37a39a] text-center text-black dark:text-[#fff] rounded-[3px] mt-8 cursor-pointer`}
              required
              value="Update"
              type="submit"
            />
...
export default ChangePassword; // Ensure this is the last line